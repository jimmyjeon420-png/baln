/**
 * 법정동코드 매핑 테이블 (전국 시군구 → 5자리 LAWD_CD)
 *
 * 비유: "우편번호부"
 * 카카오 검색 결과의 주소 텍스트를 국토부 API가 이해하는
 * 5자리 코드로 변환해주는 번역 사전입니다.
 *
 * 사용: extractLawdCd("서울 강남구 대치동 316") → "11680"
 */

// ============================================================================
// 전국 시군구 → 법정동코드 매핑 (시도+시군구 기준)
// ============================================================================
...
const LAWD_MAP: Record<string, string> = {
  ...
  '충남 논산시': '44230', '충남 계룡시': '44250', '충남 당진시': '44270',
  ...
  '전북 군산시': '45130', '전북 익산시': '45140',
  '전북 정읍시': '45180', '전북 남원시': '45190',
  '전북 김제시': '45210',
  ...
  '경남 밀양시': '48270', '경남 거제시': '48310', '경남 양산시': '48330',
  '경남 의령군': '48720', '경남 함안군': '48730', '경남 창녕군': '48740',
  '경남 고성군': '48820', '경남 남해군': '48840',
  '경남 하동군': '48850', '경남 산청군': '48860',
...
// ============================================================================
// 주소 텍스트에서 법정동코드(5자리) 추출
// ============================================================================

/**
 * 카카오 API 주소 문자열에서 법정동코드(LAWD_CD) 5자리 추출
 *
 * @param address - "서울 강남구 대치동 316" 형식
 * @returns "11680" 또는 null (매핑 실패 시)
 *
 * 처리 케이스:
 * 1) "서울 강남구 ..." → "서울 강남구" 매핑
 * 2) "경기 성남시 분당구 ..." → "경기 성남시 분당구" 매핑
 * 3) "서울특별시 강남구 ..." → "서울 강남구" 변환 후 매핑
 */
