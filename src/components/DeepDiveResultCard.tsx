...
const styles = StyleSheet.create({
  ...
  ticker: { color: '#FFF', fontSize: 25, fontWeight: '800' },
  name: { color: '#888', fontSize: 15, marginTop: 2 },
  ...
  highlight: { color: '#CCC', fontSize: 14, lineHeight: 21, marginBottom: 2 },
  ...
  newsTitle: { color: '#CCC', fontSize: 14, fontWeight: '600' },
  newsImpact: { color: '#666', fontSize: 12, marginTop: 2 },
  summary: { color: '#CCC', fontSize: 14, lineHeight: 21, marginBottom: 10 },
  subHeader: { color: '#FFF', fontSize: 14, fontWeight: '700', marginTop: 8, marginBottom: 4 },
  targetRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, paddingTop: 8, borderTopWidth: 0.5, borderTopColor: '#333' },
  targetLabel: { color: '#888', fontSize: 13 },
