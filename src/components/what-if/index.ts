...
// 데이터 re-export
export { getExtremeScenarios, getScenariosByLocale, CATEGORY_COLORS } from '../../data/whatIfScenarios';
export type { ExtremeScenario, SectorImpact, HistoricalParallel, MarketImpactMetrics } from '../../data/whatIfScenarios';
