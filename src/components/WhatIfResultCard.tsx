...
const styles = StyleSheet.create({
  ...
  impactLabel: { color: '#888', fontSize: 13, marginBottom: 4 },
  impactValue: { color: '#FFF', fontSize: 17, fontWeight: '700' },
  changeBadge: {
    alignSelf: 'center',
  ...
  assetLeft: {},
  assetTicker: { color: '#FFF', fontSize: 15, fontWeight: '700' },
  assetName: { color: '#666', fontSize: 12 },
  assetRight: { alignItems: 'flex-end' },
  assetChange: { fontSize: 15, fontWeight: '700' },
  levelDot: {
    paddingHorizontal: 6,
    paddingVertical: 2,
    borderRadius: 4,
