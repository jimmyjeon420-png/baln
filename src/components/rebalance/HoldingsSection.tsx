...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  snapshotLabel: { fontSize: 13, marginBottom: 4 },
  snapshotValue: { fontSize: 17, fontWeight: '700' },
  ...
  assetTicker: { fontSize: 15, fontWeight: '600' },
  assetName: { fontSize: 13, marginTop: 1 },
  assetRight: { alignItems: 'flex-end' },
  assetWeight: { fontSize: 15, fontWeight: '600' },
  assetGain: { fontSize: 13, fontWeight: '600', marginTop: 2 },
});
