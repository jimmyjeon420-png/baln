...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  collapsibleTitle: { fontSize: 14, fontWeight: '600' },
  collapsibleCount: { fontSize: 12 },
  collapsibleBody: {
    marginHorizontal: 16,
    backgroundColor: colors.surface,
    borderRadius: 12,
  ...
  snapshotLabel: { fontSize: 11, marginBottom: 4 },
  ...
  assetTicker: { fontSize: 13, fontWeight: '600' },
  assetName: { fontSize: 11, marginTop: 1 },
  assetRight: { alignItems: 'flex-end' },
  assetWeight: { fontSize: 13, fontWeight: '600' },
