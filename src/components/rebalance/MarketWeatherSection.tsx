...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  marketTitle: { fontSize: 16, fontWeight: '700', marginBottom: 10 },
  highlights: { gap: 6, marginBottom: 10 },
  highlightRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 },
  highlightDot: { fontSize: 15, lineHeight: 22 },
  highlightText: { flex: 1, fontSize: 15, lineHeight: 22 },
  rateBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 10,
  ...
  rateText: { fontSize: 14, fontWeight: '500', flex: 1 },
  ...
  realEstateAnalysis: { fontSize: 15, lineHeight: 22, marginBottom: 10 },
  realEstateRecBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 10,
  ...
  realEstateRecText: { flex: 1, fontSize: 14, fontWeight: '500', lineHeight: 20 },
  cfoDetailSection: {
    borderRadius: 12,
    padding: 14,
    borderWidth: 1,
  ...
  cfoDetailStatus: { fontSize: 16, fontWeight: '700' },
  cfoDetailMessage: { fontSize: 15, lineHeight: 22 },
  detailTime: { fontSize: 13, textAlign: 'right' },
  showMoreHint: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 10, gap: 4 },
  showMoreHintText: { fontSize: 14, fontWeight: '500' },
});
