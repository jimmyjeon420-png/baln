...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  sentimentText: { fontSize: 13, fontWeight: '700' },
  expandButton: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  expandButtonText: { fontSize: 13 },
  marketTitle: { fontSize: 15, fontWeight: '700', marginBottom: 10 },
  highlights: { gap: 6, marginBottom: 10 },
  highlightRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 },
  highlightDot: { fontSize: 14, lineHeight: 21 },
  highlightText: { flex: 1, fontSize: 14, lineHeight: 21 },
  rateBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 10,
  ...
  rateText: { fontSize: 13, fontWeight: '500', flex: 1 },
  ...
  realEstateAnalysis: { fontSize: 14, lineHeight: 21, marginBottom: 10 },
  realEstateRecBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 10,
  ...
  realEstateRecText: { flex: 1, fontSize: 13, fontWeight: '500', lineHeight: 19 },
  cfoDetailSection: {
    borderRadius: 12,
    padding: 14,
    borderWidth: 1,
  ...
  cfoDetailEmoji: { fontSize: 21 },
  cfoDetailStatus: { fontSize: 15, fontWeight: '700' },
  cfoDetailMessage: { fontSize: 14, lineHeight: 21 },
  detailTime: { fontSize: 12, textAlign: 'right' },
  showMoreHint: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 10, gap: 4 },
  showMoreHintText: { fontSize: 13, fontWeight: '500' },
});
